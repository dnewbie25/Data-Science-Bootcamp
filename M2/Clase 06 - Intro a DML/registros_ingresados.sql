...
INSERT instructores (cedula, nombre, apellido, fecha_nacimiento, fecha_incorporacion) 
...
ALTER TABLE henry.cohorte
MODIFY codigo varchar(20); 
INSERT INTO cohorte (idCohorte,codigo,carrera,instructor,fecha_inicio, fecha_finalizacion)
VALUES (1235,'FT-1235',2,2,'2020-2-1','2020-6-30'),
(1236,'FT-1236',2,3,'2020-4-5','2020-8-31'),
(1237,'FT-1237',2,2,'2021-7-5','2021-11-30'),
(1238,'FT-1238',2,3,'2021-9-6','2022-1-31'),
(1239,'FT-1239',2,4,'2022-1-10',null),
(1240,'FT-1240',2,5,'2022-2-7',null),
(1241,'FT-1241',2,6,'2022-3-7',null),
(1242,'DS-1242',3,7,'2022-3-28',null),
(1243,'FT-1243',2,8,'2022-4-4',null),
(1244,'DS-1244',3,9,'2022-5-2',null),
(1245,'FT-1245',2,3,'2022-5-2',null),
(1246,'DS-1246',3,8,'2022-7-4',null);

INSERT INTO cohorte (codigo, carrera, instructor, fecha_inicio, fecha_finalizacion)
VALUES ('FT-1235',2,2,'2020-2-1','2020-6-30');

#Se insertan valores en la tabla alumnoss.

INSERT INTO alumnoss (idAlumno,cedula,nombre,apellido,fecha_nacimiento,fecha_ingreso,cohorte)
VALUES (1,'274352477','Candice','Rojas','2000-12-10','2020-01-21',1235);
ALTER TABLE henry.alumnoss
...
INSERT INTO alumnos (idAlumno,cedula,nombre,apellido,fecha_nacimiento,fecha_ingreso,cohorte)
